//
//  GetNewsSwiftyJSON.swift
//  vk-api
//
//  Created by Илья Лебедев on 13.08.2021.
//
...
final class GetNewsListSwiftyJSON {
    ...
    func get (comlition: @escaping ([PostNews]) -> Void){
    ...
    func parse(_ data: Data?) -> [PostNews] {
    ...
    func makeNewsList(_ items: [NewsResponseItemSwifty],
        ...
        var newsList: [PostNews] = []
            ...
            for item in items {
                ...
                var newItem = PostNews(name: "", avatar: "", date: "", textNews: item.text, imageNews: item.imgUrl, likes: item.likes, comments: item.comments, reposts: item.reposts, views: item.views)
